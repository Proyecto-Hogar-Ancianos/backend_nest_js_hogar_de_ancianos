...
export class ProgramDataDto {
    ...
    @Type(() => SubProgramDataDto)
    sub_programs?: SubProgramDataDto[];
}
...
export class ClinicalConditionDataDto {
...
export class ClinicalHistoryDataDto {
    ...
    @IsArray()
    @ValidateNested({ each: true })
    @Type(() => ClinicalConditionDataDto)
    clinical_conditions?: ClinicalConditionDataDto[];
    ...
    medications?: MedicationDataDto[];
}

export class CreateVirtualRecordDirectDto {
